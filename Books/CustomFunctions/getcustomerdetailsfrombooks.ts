...
cutstomerDetailsReponse = invokeurl
[
	url :"https://www.zohoapis.com/books/v3/contacts?organization_id=701437914&page=1&per_page=1"
	type :GET
	connection:"zbooks"
];
//info cutstomerDetailsReponse;
customerList = list();
for each  customerData in cutstomerDetailsReponse.get("items")
{
	customerDetails = customerData.get("contact");
	...
	customerDetailsMap.put("Contact_Type",ifnull(customerDetails.get("contact_type"),""));
	...
	customerList.add(customerDetailsMap);
}
info customerList;
// for each  customerDetails in customerList
// {
// 	// 	info cust_map ;
...
// 	{
// 		update_creator = zoho.creator.updateRecord("rbermejo","latin-core-order-management","All_Customers",customerDetails.get("custom_field_hash").get("cf_zoho_creator_id"),customerDetails,Map(),"zcreator");
// 		// 	info update_creator;
// 	}
// 	else
// 	{
// 		res_creator = zoho.creator.createRecord("rbermejo","latin-core-order-management","Customers",customerDetails,Map(),"zcreator");
// 		//info res_creator;
