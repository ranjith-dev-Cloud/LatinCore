$(document).ready(function () {
  ...
  //       if (response.code == 3000) {
  //         $.each(response.data, function (index, dataList) {
  //           $('#salesPerson').append('<option value="' + dataList.Zoho_Books_ID + '">' + dataList.Sales_Person + '</option>');
  //         });
  //       } else {
  //         console.log("Error Calling Creator API:" + response.code);
  //       }
  ...
  //           $(".modal-body #salesAccount").text();
  //           $(".modal-body #purchasePrice").text();
  //           $(".modal-body #purchaseAccount").text();
  //           $(".modal-body #stockOnHand").text();
  //           $(".modal-body #committedStock").text();
  //           $(".modal-body #availableForSale").text();
  //           $(".modal-body #committedStock").text();
  //           $(".modal-body #committedStock").text();
